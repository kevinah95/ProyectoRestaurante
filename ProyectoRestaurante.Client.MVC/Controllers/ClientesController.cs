...
namespace ProyectoRestaurante.Client.MVC.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCliente,Nombre,Ap1,Ap2,NumTelefono,CorreoElectronico")] Clientes clientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCliente,Nombre,Ap1,Ap2,NumTelefono,CorreoElectronico")] Clientes clientes)
        {
